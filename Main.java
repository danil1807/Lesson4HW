...
public class Main {
   ...
   // пробовал решить автоматизацию проверки. Работает, если вводим не крайние значения крестиков (1:1, 5:5...)
   // не понимаю, как избежать того, чтобы при проверке победы машина не вылазила за пределы массива. 
